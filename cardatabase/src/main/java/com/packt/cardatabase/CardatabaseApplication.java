...
public class CardatabaseApplication implements CommandLineRunner {
	...
	// permite imprimir por consola mensajes
	...
	public void run(String... args) throws Exception {
		...
		repository.save(new Car("Ford", "Mustang", "Red", "ADF-1121", 2023, 59000, "Ford Mustand Red 2023", owner1));
		repository.save(new Car("Nissan", "Leaf", "White", "SSJ-3002", 2020, 29000, "Nissan Leaf White 2020", owner2));
		repository.save(
				new Car("Toyota", "Prius", "Silver", "KKO-0212", 2022, 39000, "Toyota Prius Silver 2022", owner2));
